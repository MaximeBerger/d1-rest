      ...
      "questions": [
        {
          ...
          "answers": [
            ...
            { "text": "$\\dfrac{6}{8}$", "correct": false, "remediation": "Le numérateur et le dénominateur sont pairs tous les deux donc on peut les diviser par 2." },
            { "text": "$\\dfrac{2}{3}$", "correct": false, "remediation": "Tu as divisé $6$ par $3$ pour obtenir $2$, mais le dénominateur devrait aussi être divisé par $3$." },
            { "text": "$\\dfrac{4}{3}$", "correct": false, "remediation": "Tu as inversé le numérateur et le dénominateur." }
          ]
        },
        {
